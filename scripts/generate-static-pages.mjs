...
function header(prefix) {
  return `<header class="site-header"><div class="header-inner"><a class="brand" href="${prefix}"><span class="brand-mark">KD</span><span>금동호</span></a><nav class="desktop-nav" aria-label="주요 메뉴"><a data-nav-link href="${prefix}">홈</a><a data-nav-link href="${prefix}projects/">프로젝트</a><a data-nav-link href="${prefix}skills/">기술 스택</a><a data-nav-link href="${prefix}about/">소개</a></nav><button class="menu-button" type="button" data-menu-toggle aria-expanded="false" aria-controls="mobile-menu" aria-label="모바일 메뉴 열기">☰</button></div><nav id="mobile-menu" class="mobile-menu" data-mobile-menu hidden aria-label="모바일 메뉴"><a data-nav-link href="${prefix}">홈</a><a data-nav-link href="${prefix}projects/">프로젝트</a><a data-nav-link href="${prefix}skills/">기술 스택</a><a data-nav-link href="${prefix}about/">소개</a></nav></header>`;
}
